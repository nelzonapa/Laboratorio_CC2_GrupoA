...
*/
/*
EJERCICIO 5. Desarrolle una función que permita eliminar el primer elemento 
de una lista sin perder referencia de los demás elementos que ya se encuentran 
almacenados en la estructura .(Evite copiar los elementos en una nueva lista para completar la
    ...
    do
    {
        ...
        switch (opcion)
        {
            ...
            case 2:
                ...
                // en caso de tener la cabeza vacía, pero con otros nodos
                else if (Temp==NULL)
                {
                    Temp=Temp->get_enlace();//avanza una vez
                    while ((Temp!=NULL))
                    {
                        cout<<Temp->get_numero()<<" ";//imrpimimos
                        //avanzamos al siguiente
